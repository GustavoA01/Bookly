...
describe('BookSynopsis', () => {
  it('should render synopsis and comment when both are provided', () => {
    render(<BookSynopsis synopsis="This is a great book." comment="Great characters development." />);
    ...
    expect(screen.getByText('Great characters development.')).toBeInTheDocument();
  });
  ...
  it('should render only comment when synopsis is not provided', () => {
    render(<BookSynopsis synopsis={null} comment="Great characters development." />);
  ...
  it('should render nothing when both synopsis and comment are null', () => {
    const { container } = render(<BookSynopsis synopsis={null} comment={null} />);
